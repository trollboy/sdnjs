...
var cssClasses = '{s.container  hidden-md-down visible-md visible-lg';
    ...
    return (
      <div className={s.root}>
        <div className={s.container}>
          <span className={s.text}>© Shoggoth.net and it's respective authors</span>
        </div>
        <div className={classNames(s.container, "hidden-md-down", "visible-md", "visible-lg")}>
